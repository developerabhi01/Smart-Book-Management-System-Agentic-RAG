...
from app.core.middleware import RequestTrackingMiddleware, error_handler, get_metrics_data, MetricsMiddleware
from app.db.session import get_db
from app.db.lifecycle import init_database, close_database
from app.db.health import db_health
from app.db.models import Book, Review, Author, Genre
...
from app.api.v1.schemas import BookCreate, BookResponse, BookUpdate, ReviewCreate, ReviewResponse, AuthorCreate, AuthorResponse, GenreCreate, GenreResponse, AuthorUpdate, GenreUpdate
from app.api.v1.schemas import GenerateSummaryRequest, GenerateSummaryResponse
from app.rag.rag_pipeline import rag_pipeline
from app.api.v1.routes import auth, users, documents, ingestion
...
app = FastAPI(
    ...
    description="Production-grade Smart book management system with RAG capabilities",
    version="1.0.0",
    docs_url="/docs",
    redoc_url="/redoc",
